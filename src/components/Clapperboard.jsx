...
function Clapperboard() {
  return (
    <svg className="clapperboard" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 511.816 511.816">
      <g>
      ...
      <g>
        <path d="M511.274,93.086l-18.155-68.864c-4.181-16.747-21.333-27.285-38.251-23.424l-71.68,17.024l68.011,100.267l52.117-11.861
      ...
      <g>
        <path d="M42.517,98.675l-17.387,4.117c-8.469,1.92-15.637,7.061-20.181,14.443c-4.544,7.403-5.888,16.107-3.776,24.533
